...
from utils.model_utils import AU_Losses, EXPR_Losses, VA_Losses, BackBone, Head, Model, AU_metric, EXPR_metric, \
    VA_metric
...
class ResNet50(BaseModel):
    def __init__(self, opt):
        ...
        self._name = 'ResNet50'
        self._output_size_per_task = {'AU': self._opt.AU_label_size, 'EXPR': self._opt.EXPR_label_size,
                                      'VA': self._opt.VA_label_size * self._opt.digitize_num}
        self._criterions_per_task = {'AU': self._opt.AU_criterion, 'EXPR': self._opt.EXPR_criterion,
                                     'VA': self._opt.VA_criterion}
        self.lambdas_per_task = {'AU': self._opt.lambda_AU, 'EXPR': self._opt.lambda_EXPR,
                                 'VA': [self._opt.lambda_V, self._opt.lambda_A]}
        # create networks
